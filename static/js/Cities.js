...
//   // var value = data[key];
//   console.log('js',key);
//     if (JSON.parse(data)[key]=='checked') {
//       console.log('js',document.getElementById('سیلسیلس'));
...
// console.log('js',document.getElementById('سیلسیلس'));
// console.log(JSON.parse(data)[selected]);

// for (var i = 0; i <=data.length; i++) {
//   if(JSON.parse(data)[selected] == 'checked'){
// console.log('loggg',document.getElementById(selected));
// document.getElementById(selected).checked = 'checked';
...
//   const selectedData={[selected]:"checked"};
//   sessionStorage.setItem("data",JSON.stringify(selectedData));
//    var data = sessionStorage.getItem('data');
//    if(JSON.parse(data)[selected] == 'checked'){
//    document.getElementById(selected).checked = 'checked';
//      updateOrderAddress(selected);
//  }
// }
...
// function updateShippingMethod(selected){
//   document.getElementById(selected).checked;
//   var selected=selected;
//   const selectedData={[selected]:"checked"};
//   sessionStorage.setItem("data",JSON.stringify(selectedData));
...
//    if(JSON.parse(data)[selected] == 'checked'){
//    document.getElementById(selected).checked = 'checked';
//      updateOrderShippingMethod(selected);
//  }
// }

// function updateOrderShippingMethod(shippingMethod){
//   var url='/updateShippingMethod/'
//   fetch (url,{
//     method:'POST',
//     headers:{
//       'Contend-Type':'application/json',
...
function updateCity(selectedCity){
  document.getElementById('cityName').value=selectedCity.options[selectedCity.selectedIndex].text

}

function iranwebsv(selectedState)
{
  // console.log(state.options[state.selectedIndex].text);
  document.getElementById('stateName').value=selectedState.options[selectedState.selectedIndex].text
